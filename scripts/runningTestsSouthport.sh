...
echo
#slr+hat NN
$EXECUTABLE_PATH/modelflood -e $PATH/$DEM_FILE -i $OUTPUT_PATH/$INTERP_HAT_NN -r 1 -o $OUTPUT_PATH/${DEM}_flooded_slr_bfe_hat_nn_1ft.asc --norender
echo
$EXECUTABLE_PATH/modelflood -e $PATH/$DEM_FILE -i $OUTPUT_PATH/$INTERP_HAT_NN -r 3 -o $OUTPUT_PATH/${DEM}_flooded_slr_bfe_hat_nn_3ft.asc --norender
echo
$EXECUTABLE_PATH/modelflood -e $PATH/$DEM_FILE -i $OUTPUT_PATH/$INTERP_HAT_NN -r 6 -o $OUTPUT_PATH/${DEM}_flooded_slr_bfe_hat_nn_6ft.asc --norender
echo
...
echo
#slr+hat IDW
$EXECUTABLE_PATH/modelflood -e $PATH/$DEM_FILE -i $OUTPUT_PATH/$INTERP_HAT_IDW -r 1 -o $OUTPUT_PATH/${DEM}_flooded_slr_bfe_hat_idw_1ft.asc --norender
echo
$EXECUTABLE_PATH/modelflood -e $PATH/$DEM_FILE -i $OUTPUT_PATH/$INTERP_HAT_IDW -r 3 -o $OUTPUT_PATH/${DEM}_flooded_slr_bfe_hat_idw_3ft.asc --norender
echo
$EXECUTABLE_PATH/modelflood -e $PATH/$DEM_FILE -i $OUTPUT_PATH/$INTERP_HAT_IDW -r 6 -o $OUTPUT_PATH/${DEM}_flooded_slr_bfe_hat_idw_6ft.asc --norender
